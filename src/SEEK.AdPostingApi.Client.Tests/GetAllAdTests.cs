    ...
    public class GetAllAdTests : IDisposable
    {
        ...
        public async Task GetAllAdvertisementsWithNoAdvertisementReturns()
        {
            ...
            this.Fixture.AdPostingApiService
                ...
                .UponReceiving("GET advertisements request for all advertisements")
        ...
        public async Task GetAllAdvertisementsFirstPage()
        {
            ...
            this.Fixture.AdPostingApiService
                ...
                .UponReceiving("GET advertisements request for first page of data")
                .With(new ProviderServiceRequest
                {
                    Method = HttpVerb.Get,
                    Path = "/advertisement",
        ...
        public async Task GetAllAdvertisementsNextPage()
        {
            ...
            this.Fixture.AdPostingApiService
                .Given("A page size of 3 with more than 1 page of data")
                .UponReceiving("GET advertisements request for the last page of data")
                .With(new ProviderServiceRequest
                {
                    Method = HttpVerb.Get,
                    Path = "/advertisement",
        ...
        public async Task GetAllAdvertisementsByAdvertiserFirstPage()
        {
            ...
            this.Fixture.AdPostingApiService
                .Given("A page size of 3 with more than 1 page of data")
                .UponReceiving("GET advertisements request for the first page of advertisements belonging to the advertiser")
                .With(new ProviderServiceRequest
                {
                    Method = HttpVerb.Get,
                    Path = "/advertisement",
        ...
        public async Task GetAllAdvertisementsByAdvertiserNextPage()
        {
            ...
            this.Fixture.AdPostingApiService
                .Given("A page size of 3 with more than 1 page of data")
                .UponReceiving("GET advertisements request for the second page of advertisements belonging to the advertiser")
                .With(new ProviderServiceRequest
                {
                    Method = HttpVerb.Get,
                    Path = "/advertisement",
        ...
        public async Task GetAllAdvertisementByAdvertiserWithNonExistentAdvertiserId()
        {
            ...
            this.Fixture.AdPostingApiService
                .UponReceiving("GET advertisements request to retrieve all advertisements for an advertiser that doesn't exist")
                .With(new ProviderServiceRequest
                {
                    Method = HttpVerb.Get,
                    Path = "/advertisement",
        ...
        public async Task GetAllAdvertisementsByAdvertiserReturnsRelationshipError()
        {
            ...
            this.Fixture.AdPostingApiService
                .UponReceiving("GET advertisements request to retrieve all advertisements for the advertiser not related to requestor")
                .With(new ProviderServiceRequest
                {
                    Method = HttpVerb.Get,
                    Path = "/advertisement",

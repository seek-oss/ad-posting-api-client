...
namespace SEEK.AdPostingApi.Client.Tests
{
    ...
    public class UpdateAdTests : IDisposable
    {
        ...
        public async Task UpdateStandoutJobToClassic()
        {
            ...
            var requestModel = new AdvertisementModelBuilder(this.MinimumFieldsInitializer).WithAdvertisementType(AdvertisementType.Classic).Build();
            ...
            var expectedException =
                new UnauthorizedException(
                    ...
                    {
                        Message = "Forbidden",
                        Errors = new[] { new AdvertisementError { Code = "InvalidState" } }
                    });
